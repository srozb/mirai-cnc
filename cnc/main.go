...
var DatabaseAddr string   = os.Getenv("DBHOST")
var DatabaseUser string   = os.Getenv("DBUSER")
var DatabasePass string   = os.Getenv("DBPASS")
var DatabaseTable string  = os.Getenv("DBNAME")
